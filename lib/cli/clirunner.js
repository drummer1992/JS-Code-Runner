...
const modelWarningMsg = modelName => Chalk.yellow(`IMPORTANT!
The business logic code will be deployed to model "${ Chalk.green(modelName) }".
...
either by using the ${Chalk.cyan('--model')} argument or changing the model name in coderunner.json.
Would you like to continue? (${Chalk.red('Y')}/${Chalk.green('N')})`;
