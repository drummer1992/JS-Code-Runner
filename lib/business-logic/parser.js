...
exports.parse = function(serverCode) {
  return {
    handlers: (serverCode instanceof api.EventsHandler) && parseHandler(module) || [],
    service : (serverCode instanceof api.Service) && parseService() || null
  };
};