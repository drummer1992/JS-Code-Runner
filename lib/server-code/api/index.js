...
ServerCode.Messaging = {
  ...
  beforeSendEmailByAddressesWithTemplate: handlerRegistrar(MESSAGING.events.beforeSendEmailByAddressesWithTemplate),
  afterSendEmailByAddressesWithTemplate : handlerRegistrar(MESSAGING.events.afterSendEmailByAddressesWithTemplate),
  beforeSendEmailByQueryWithTemplate    : handlerRegistrar(MESSAGING.events.beforeSendEmailByQueryWithTemplate),
  afterSendEmailByQueryWithTemplate     : handlerRegistrar(MESSAGING.events.afterSendEmailByQueryWithTemplate),
}
