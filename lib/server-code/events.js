...
addEvent(122, 'beforeAddRelation', PERSISTENCE, ['columnName', 'parentObjectId', 'children']);
addEvent(123, 'afterAddRelation', PERSISTENCE, ['columnName', 'parentObjectId', 'children', 'result']);
addEvent(124, 'beforeSetRelation', PERSISTENCE, ['columnName', 'parentObjectId', 'children']);
addEvent(125, 'afterSetRelation', PERSISTENCE, ['columnName', 'parentObjectId', 'children', 'result']);
addEvent(126, 'beforeDeleteRelation', PERSISTENCE, ['columnName', 'parentObjectId', 'children']);
addEvent(127, 'afterDeleteRelation', PERSISTENCE, ['columnName', 'parentObjectId', 'children', 'result']);
