...
addEvent(518, 'beforeSendEmailByAddressesWithTemplate', MESSAGING, ['templateName', 'addresses', 'templateValues', 'ccAddresses', 'bccAddresses']) // eslint-disable-line
addEvent(519, 'afterSendEmailByAddressesWithTemplate', MESSAGING, ['templateName', 'addresses', 'templateValues', 'ccAddresses', 'bccAddresses', 'result']) // eslint-disable-line
addEvent(520, 'beforeSendEmailByQueryWithTemplate', MESSAGING, ['templateName', 'segmentQuery', 'templateValues', 'ccAddresses', 'bccAddresses']) // eslint-disable-line
addEvent(521, 'afterSendEmailByQueryWithTemplate', MESSAGING, ['templateName', 'segmentQuery', 'templateValues', 'ccAddresses', 'bccAddresses', 'result']) // eslint-disable-line
