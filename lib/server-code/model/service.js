...
class ServiceWrapper {
  ...
  invokeMethod(method, context, args) {
    ...
    instance.config = buildConfig(this.configItems, context.configurationItems);
    instance.context = context;

    if (typeof instance[method] !== 'function') {
      throw new Error(`[${method}] method does not exist in [${this.name}] service or is not a function`);
    }
